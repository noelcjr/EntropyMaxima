...
gen_csv.py --frompsfcrd --crd 1brs_comp_1rr.crd --psf 1brs_comp_1rr_xplo.psf
del_residue.py --rem 1,1,C,ACE --inp 1brs_comp_1rr.csv --out 1brs_comp_1rr.csv
del_residue.py --rem 1,2,F,ACE --inp 1brs_comp_1rr.csv --out 1brs_comp_1rr.csv
del_residue.py --rem 110,1,C,CTER --inp 1brs_comp_1rr.csv --out 1brs_comp_1rr.csv
del_residue.py --rem 89,2,F,CTER --inp 1brs_comp_1rr.csv --out 1brs_comp_1rr.csv
cd ..
...
gen_csv.py --frompsfcrd --crd 2hiu_1rr_no_disulf.crd --psf 2hiu_1rr_no_disulf_xplo.psf 
del_residue.py --rem 1,1,A,ACE --inp 2hiu_1rr_no_disulf.csv --out 2hiu_1rr_no_disulf.csv
del_residue.py --rem 1,2,B,ACE --inp 2hiu_1rr_no_disulf.csv --out 2hiu_1rr_no_disulf.csv
del_residue.py --rem 21,1,A,CTER --inp 2hiu_1rr_no_disulf.csv --out 2hiu_1rr_no_disulf.csv
del_residue.py --rem 30,2,B,CTER --inp 2hiu_1rr_no_disulf.csv --out 2hiu_1rr_no_disulf.csv
cd ..
...
gen_csv.py --frompsfcrd --crd 2hiu_1rr.crd --psf 2hiu_1rr_xplo.psf
del_residue.py --rem 1,1,A,ACE --inp 2hiu_1rr.csv --out 2hiu_1rr.csv
del_residue.py --rem 1,2,B,ACE --inp 2hiu_1rr.csv --out 2hiu_1rr.csv
del_residue.py --rem 21,1,A,CTER --inp 2hiu_1rr.csv --out 2hiu_1rr.csv
del_residue.py --rem 30,2,B,CTER --inp 2hiu_1rr.csv --out 2hiu_1rr.csv
cd ..
